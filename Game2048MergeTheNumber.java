...
public class Game2048MergeTheNumber extends JFrame implements KeyListener {
	...
	public Game2048MergeTheNumber() {
		setTitle("2048 : Drop The Number");
		ImageIcon img = new ImageIcon("Designer.png");
		...
		for (int i = 0; i < 4; i++) {
			for (int j = 0; j < 4; j++) {
				...
				label[i][j].setFont(new Font("Courier New", Font.BOLD, 36));
				value[i][j] = 0;
				add(label[i][j]);
				label[i][j].setBorder(BorderFactory.createLineBorder(Color.GREEN, 1));
			}
		}
		addKeyListener(this);
	...
	public static void main(String args[]) {
		@SuppressWarnings("unused")
		Game2048MergeTheNumber game = new Game2048MergeTheNumber();
	}
}